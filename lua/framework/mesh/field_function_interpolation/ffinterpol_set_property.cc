...
chiFFInterpolationSetProperty(lua_State* L)
{
  ...
  //   //                          << " used in chiFFInterpolationSetProperty. Number of points
  //   must"
  ...
  //   //                          << " used in chiFFInterpolationSetProperty. Argument 3 is
  //   expected "
  //   //                             "to be an array.";
  //   //   Chi::Exit(EXIT_FAILURE);
  //   // }
  ...
  //   //                          << " used in chiFFInterpolationSetProperty. Unsupported
  //   OPERATON."
