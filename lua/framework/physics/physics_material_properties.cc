...
chiPhysicsMaterialAddProperty(lua_State* L)
{
  ...
  // else
  // {
  //   Chi::log.Log0Error() << "Unsupported property type in call to
  //   chiPhysicsMaterialAddProperty."; Chi::Exit(EXIT_FAILURE);
  // }
...
chiPhysicsMaterialSetProperty(lua_State* L)
{
  ...
  //   {
  //     for (int p = 0; p < cur_material->properties_.size(); p++)
  //       if (cur_material->properties_[p]->Type() == MatProperty::SCALAR_VALUE) location_of_prop =
  //       p;
  //   }
  //   else
  //   {
