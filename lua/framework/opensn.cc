...
#include "lua/framework/aquad.h"
#include "lua/framework/mesh.h"
#include "lua/framework/fieldfunc.h"
#include "lua/framework/logger.h"
#include "lua/framework/post.h"
#include "lua/framework/solver.h"
#include "lua/framework/xs.h"
#include "lua/framework/mat.h"
#include "lua/framework/lbs.h"
...
static bool reg = opensnlua::Console::Bind(
  [](lua_State* L)
  {
    ...
    luabridge::getGlobalNamespace(L)
      ...
      .addVariable("GAUSS_LEGENDRE_LEGENDRE",
                   opensn::ProductQuadratureType::GAUSS_LEGENDRE_LEGENDRE)
    ...
    luabridge::getGlobalNamespace(L)
      ...
      .endClass()
      .beginClass<std::shared_ptr<PowerIterationKEigenSMM>>("PowerIterationKEigenSMM")
      .endClass()
      //
