...
option(OPENSN_WITH_CODE_COVERAGE "Builds targets with code coverage instrumentation" OFF)

if(OPENSN_WITH_CODE_COVERAGE)
    ...
    if(CMAKE_C_COMPILER_ID MATCHES "(Apple)?[Cc]lang" OR CMAKE_CXX_COMPILER_ID MATCHES "(Apple)?[Cc]lang")
        ...
        set(CODE_COVERAGE_BINS
            --object=${PROJECT_BINARY_DIR}/libopensn${CMAKE_SHARED_LIBRARY_SUFFIX}
            --object=${PROJECT_BINARY_DIR}/lua/libopensnlua${CMAKE_SHARED_LIBRARY_SUFFIX}
        )
        ...
        add_custom_command(
            OUTPUT
                ${COVERAGE_INFO}
            COMMAND
                ${LLVM_COV_PATH} export ${CODE_COVERAGE_BINS} -instr-profile=${MERGED_PROFDATA} -format="lcov"
                    ${EXCLUDE_REGEX} > ${COVERAGE_INFO}
            DEPENDS
                ${MERGED_PROFDATA}
        )
        ...
        add_custom_command(
            OUTPUT
                ${MERGED_PROFDATA}
            COMMAND
                ${LLVM_PROFDATA_PATH} merge -sparse -o ${MERGED_PROFDATA} test/*.profraw
        )
        ...
        add_custom_command(
            ...
            COMMAND
                ${LLVM_COV_PATH} show ${CODE_COVERAGE_BINS} -instr-profile=${MERGED_PROFDATA}
                    -show-line-counts-or-regions -output-dir=${CMAKE_BINARY_DIR}/htmlcov -format="html" ${EXCLUDE_REGEX}
            DEPENDS
                ${COVERAGE_INFO}
        )
    ...
    elseif(CMAKE_C_COMPILER_ID MATCHES "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES "GNU")
        ...
        add_custom_command(
            OUTPUT
                ${COVERAGE_INFO}
            COMMAND
                ${LCOV_PATH} --capture --directory ${PROJECT_BINARY_DIR} --output-file ${COVERAGE_INFO} ${EXCLUDE_REGEX}
        )
