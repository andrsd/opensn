...
double
NormL1(const std::vector<double>& x)
{
  // Local Variables
  size_t n = x.size();
  double val = 0.0;
...
double
NormL2(const std::vector<double>& x)
{
  // Local Variables
  size_t n = x.size();
  double val = 0.0;
...
double
NormLInfinity(const std::vector<double>& x)
{
  // Local Variables
  size_t n = x.size();
  double val = 0.0;
...
double
NormLp(const std::vector<double>& x, const double& p)
{
  // Local Variables
  size_t n = x.size();
  double val = 0.0;
