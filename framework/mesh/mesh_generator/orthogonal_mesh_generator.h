...
public:
  ...
  explicit OrthogonalMeshGenerator(opensn::App& app, const chi::InputParameters& params);
...
protected:
  ...
  CreateUnpartitioned1DOrthoMesh(opensn::App& app, const std::vector<double>& vertices);
