 ...
 * Example:
 * \code
 * OpenSnRegisterObjectNamespace(kaka, Zorba);
 * \endcode
 * \note Remember to include the header "Object/ObjectFactory.h".*/
#define OpenSnRegisterObjectNamespace(namespace_name, object_name)                                 \
 ...
 * Example:
 * \code
 * OpenSnRegisterObjectParametersOnlyNamespace(kaka, Zorba);
 * \endcode
 *
 * \note Remember to include the header "Object/object_maker.h"*/
#define OpenSnRegisterObjectParametersOnlyNamespace(namespace_name, object_name)                   \
  static char OpenSnObjectFactoryJoinWordsB(unique_var_name_object_##object_name##_,               \
                                            __COUNTER__) =                                         \
 ...
 * Example:
 * \code
 * OpenSnRegisterSyntaxBlockNamespace(kaka, Zorba, ZorbaSyntaxFunction);
 * \endcode
 *
 * \note Remember to include the header "Object/object_maker.h"*/
#define OpenSnRegisterSyntaxBlockNamespace(namespace_name, block_name, syntax_function)            \
