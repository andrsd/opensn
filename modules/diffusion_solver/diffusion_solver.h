...
private:
  ...
  enum MaterialMode
  {
    DIFFUSION_MATERIALS_REGULAR = 10,
    DIFFUSION_MATERIALS_FROM_TRANSPORTXS_TTR = 11,
    DIFFUSION_MATERIALS_FROM_TRANSPORTXS_TTF = 12,
    DIFFUSION_MATERIALS_FROM_TRANSPORTXS_TTF_JPART = 13,
    DIFFUSION_MATERIALS_FROM_TRANSPORTXS_TTF_JFULL = 14
  };
...
public:
  ...
  MaterialMode material_mode_ = DIFFUSION_MATERIALS_REGULAR;
