...
if __name__ == "__main__":
    ...
    pps_xmin_min = SurfacePostprocessor(problem=phys, value_type="min", current_type="net", boundaries=["xmin"])
    ...
    pps_xmin_max = SurfacePostprocessor(problem=phys, value_type="max", current_type="net", boundaries=["xmin"])
    ...
    pps_xmin_int = SurfacePostprocessor(problem=phys, value_type="integral", current_type="net", boundaries=["xmin"])
    ...
    pps_xmin_g1_min = SurfacePostprocessor(
        problem=phys, value_type="min", group=4, current_type="net", boundaries=["xmin"]
    )
    ...
    pps_xmin_g1_max = SurfacePostprocessor(
        problem=phys, value_type="max", group=4, current_type="net", boundaries=["xmin"]
    )
    ...
    pps_xmin_g1_int = SurfacePostprocessor(
        problem=phys, value_type="integral", group=4, current_type="net", boundaries=["xmin"]
    )
    ...
    pps_xmin_gs1_min = SurfacePostprocessor(
        problem=phys, value_type="min", groupset=1, current_type="net", boundaries=["xmin"]
    )
    ...
    pps_xmin_gs1_max = SurfacePostprocessor(
        problem=phys, value_type="max", groupset=1, current_type="net", boundaries=["xmin"]
    )
    ...
    pps_xmin_gs1_int = SurfacePostprocessor(
        problem=phys, value_type="integral", groupset=1, current_type="net", boundaries=["xmin"]
    )
