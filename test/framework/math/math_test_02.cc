...
chi_math_Test02_ParallelVector(const chi::InputParameters&)
{
  ...
  // vec.ComputeNorm(chi_math::NormType::L1_NORM); Chi::log.LogAll() << "Parallel vector norm-2: "
  // << vec.ComputeNorm(chi_math::NormType::L2_NORM); Chi::log.LogAll() << "Parallel vector
  // norm-inf: "
